...
class CinescopeRegister:
    ...
    def enter_full_name(self, fullname: str):
        self.page.fill(self.full_name_input, fullname)
    ...
    def register(self, fullname:str, email:str, password:str, confirm_password:str):
        self.enter_full_name(fullname)
        self.enter_email(email)
        self.enter_password(password)
