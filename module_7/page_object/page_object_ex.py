...
def test_page_objec():
   with sync_playwright() as playwright:
        ...
        page.locator(".GzLjMd").first.wait_for(state="visible", timeout=10_000)
        page.locator(".GzLjMd").first.locator("#L2AGLb").click()
        #Добавлен код, что ждет диалоговое окно о куках, жмет кнопку accept all
