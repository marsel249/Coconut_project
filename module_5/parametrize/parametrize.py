...
#     "works_now",
#     pytest.param("buggy_case", marks=pytest.mark.xfail(reason="Known bug in API")),
#     pytest.param("unsupported_case", marks=pytest.mark.skip(reason="Not supported on Mac")),
# ])
# def test_example(case):
#     if case == "works_now":
#         assert 1 + 1 == 2
#     elif case == "buggy_case":
#         assert 1 + 1 == 3  # специально ломаем
#     elif case == "unsupported_case":
#         assert 1 + 1 == 2  # даже не запустится, потому что skip
